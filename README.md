...
**What the simulator still does NOT model.** Spec v1.2's bimodal split for Maternity (T11) — routine delivery vs NICU treatment — is collapsed to a single log-normal. The gap modestly understates catastrophic NICU tail exposure; for typical SMB populations the impact on P95 is sub-1%.
